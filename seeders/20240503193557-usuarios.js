...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('usuario', [
            { id: crypto.randomUUID(), email: 'zs20018205@estudiantes.uv.mx', passwordhash: await bcrypt.hash('patito', 10), nombre: 'Maricarmen Vazquez', rolid: AdministradorUUID, protegido: true, createdAt: new Date(), updatedAt: new Date() },
